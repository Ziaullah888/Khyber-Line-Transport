...
const Footer = () => {
  ...
  <div className="max-w-7xl bg-[#212529] mx-auto pt-20 h-130 px-6 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    <div className=''>
      ...
      <form className="flex flex-col space-y-3">
        ...
        <p className='text-gray-400 text-medium pt-5'>
          Our expertise, as well as our passion for web design, sets us agenciese
        </p>
